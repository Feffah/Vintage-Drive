        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasOriginalDocuments = table.Column<bool>(type: "bit", nullable: false),
                    Condition = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IsAsiCertified = table.Column<bool>(type: "bit", nullable: false),
                    CertificationDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsRoadLegal = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarsCategories", x => new { x.CarsCarId, x.CategoriesCategoryId });
                    table.ForeignKey(
                        name: "FK_CarsCategories_Cars_CarsCarId",
                        column: x => x.CarsCarId,
                        principalTable: "Cars",
                        principalColumn: "CarId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CarsCategories_Categories_CategoriesCategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CarsCategories_CategoriesCategoryId",
